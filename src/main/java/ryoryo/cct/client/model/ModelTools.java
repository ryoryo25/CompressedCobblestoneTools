...
public class ModelTools implements IModel {
	...
	public ModelTools(ResourceLocation texture) {
	...
	public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
		try {
			...
			IModel toolModel = parentModel.retexture(ImmutableMap.of(TEX_VAR_NAME, this.textureLocation.toString()));

			return toolModel.bake(state, format, bakedTextureGetter);
		}
		catch(Exception e) {
